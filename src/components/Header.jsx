          ...
          <div className=" text-center md:text-start my-20 flex flex-wrap flex-col items-center md:items-start gap-4 z-50 lg:w-3/5 w-5/6">
            ...
            <div className="mt-10 flex flex-col md:flex-row gap-2 md:gap-7 scale-75 md:scale-100">
              <Link
                ...
                smooth={true}
                duration={800}
                className="min-w-[250px] px-5 py-2 w-min text-3xl bg-white text-black font-light text-center flex justify-center items-center rounded-bl-3xl rounded-tr-3xl border-none hover:scale-x-105 hover:font-normal transition-all duration-300 cursor-pointer"
              >
                Servicios
              </Link>
              <Link
          ...
          <div className="z-50 flex flex-row md:flex-col items-center justify-center my-auto gap-10">
            <Link to="">
              <svg
                ...
                fill="currentColor"
                className="cursor-pointer w-8 h-8 text-white/50 hover:text-blue-500 hover:scale-150 transition duration-300"
                viewBox="0 0 16 16"
              >
            ...
            <Link to="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="cursor-pointer w-8 h-8 text-white/50 hover:text-pink-700 hover:scale-150 transition duration-300"
                viewBox="0 0 16 16"
              >
            ...
            <Link to="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="cursor-pointer w-8 h-8 text-white/50 hover:text-red-600 hover:scale-150 transition duration-300"
                viewBox="0 0 16 16"
              >
            ...
            <Link to="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="cursor-pointer w-8 h-8 text-white/50 hover:text-slate-900 hover:scale-150 transition duration-300"
                viewBox="0 0 16 16"
              >
